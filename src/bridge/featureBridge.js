...
module.exports = {
  ...
  initialize() {
    ...
    ipcMain.handle('settings:get-use-default-api-key', async () => await settingsService.getUseDefaultApiKey());
    ipcMain.handle('settings:set-use-default-api-key', async (event, useDefault) => await settingsService.setUseDefaultApiKey(useDefault));
